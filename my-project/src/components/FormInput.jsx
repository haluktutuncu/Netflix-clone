      ...
      {({
        ...
        <form onSubmit={handleSubmit} className="flex text-white relative ">
          ...
          <div className="gap-x-1 flex">
            <div
              className={` absolute border-2 w-[376px] h-[60px] translate-x-[-3px] translate-y-[-2px] rounded-md ${
            ...
            <input
              ...
              className={`min-w-[370px] h-[56px] bg-black/50 p-4  ${
            ...
            {errors.email && touched.email && errors.email && (
              <div
                className={`absolute translate-x-4 translate-y-14 text-[14px] flex items-center justify-center`}
              >
                <div>
                  <svg
                    className="fill-[red] "
            ...
            <div className="w-[209px] h-[56px]">
              <button
                className="bg-[red] w-full h-full font-bold text-[25px] rounded-md flex items-center justify-center gap-x-2 transition-all hover:bg-red-700"
                type="submit"
