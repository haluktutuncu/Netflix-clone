...
export default function HeaderHome() {
  return (
    <div className="absolute w-full h-[68px] flex items-center justify-between bg-transparent text-[14px] font-[400] ">
      ...
      <div className="flex items-start justify-center gap-[16px] mr-[20px] ">
        <div>
          {" "}
          <svg
            width="24"
        ...
        <Link to="/account">
          <div className="border-2 w-8 h-8 border-black"></div>{" "}
        </Link>
      </div>
    </div>
  );
